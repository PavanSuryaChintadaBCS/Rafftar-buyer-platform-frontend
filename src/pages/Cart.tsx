      ...
      <main className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-sm text-muted-foreground/70 mt-1">Browse our catalog and add products to get started</p>
            <Link to="/">
                      ...
                      {supplierItems.map((item) => {
                        ...
                        return (
                          <div key={item.productId} className="flex gap-4 items-start py-4 first:pt-0 last:pb-0">
                            <Link to={`/product/${product.id}`} className="h-16 w-16 bg-secondary/30 rounded-lg flex items-center justify-center flex-shrink-0 hover:bg-secondary/50 transition-colors">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground mt-0.5">₹{unitPrice}/{product.unit}</p>
                              {belowMoq && (
                            ...
                            <div className="text-right flex-shrink-0">
                              <p className="text-sm font-bold">₹{Math.round(unitPrice * item.quantity).toLocaleString()}</p>
                              <Button
                                variant="ghost"
                                size="sm"
