          ...
          <div className="flex flex-col sm:flex-row gap-5 items-start">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-2 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-1"><Star className="h-4 w-4 fill-primary text-primary" /> {supplier.rating} ({supplier.reviewCount} reviews)</span>
                <span className="flex items-center gap-1"><Calendar className="h-4 w-4" /> Est. {supplier.established}</span>
                <span className="flex items-center gap-1"><Package className="h-4 w-4" /> {supplier.productCount} products</span>
              </div>
